...
Figure 1 shows the overlapping text problem observed at one of the sorting stations ([overlap.png](../overlap.png)). Multiple blue text objects are rendered in front of the instruction board, making the algorithm description and key prompts largely unreadable.
