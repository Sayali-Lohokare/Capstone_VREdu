...
Figure 1 [overlap.png](../overlap.png) illustrates the overlapping text problem observed at one of the sorting stations. Multiple blue text objects are rendered in front of the instruction board, making the algorithm description and key prompts largely unreadable.
